...
=======
 * Vue.js v2.5.8
>>>>>>> cf4e542c03f29fbbf1f279b2de31aee357e42abd
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        axios.get('/customers').then(function (_ref) {
            var data = _ref.data;
              ...
              return _c("div", [
                _c("div", { staticClass: "panel-body" }, [
                  _c("div", [
                    _vm._v(
                      "\n                            " +
                        _vm._s(customer.prenom) +
                        " " +
                        _vm._s(customer.nom) +
                        " " +
                        _vm._s(customer.login) +
                        "\n                        "
                    )
                  ])
                ])
...
Component.options.__file = "resources/assets/js/views/infoPerso.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3b72d288", Component.options)
  } else {
    hotAPI.reload("data-v-3b72d288", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        axios.get('/greendom').then(function (_ref) {
            var data = _ref.data;
            return _this.greendom = data;
        });
    }
});
          ...
          _c("div", [
            _c("div", { staticClass: "panel-body" }, [
              _c("div", [
                _vm._v(
                  "\n                            " +
                    _vm._s(_vm.greendom.nom) +
                    " " +
                    _vm._s(_vm.greendom.email) +
                    " " +
                    _vm._s(_vm.greendom.skye) +
                    " " +
                    _vm._s(_vm.greendom.twitter) +
                    "\n                            " +
                    _vm._s(_vm.greendom.telephone) +
                    " " +
                    _vm._s(_vm.greendom.fax) +
                    " " +
                    _vm._s(_vm.greendom.adresse) +
                    "\n                        "
                )
              ])
            ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3b72d288", module.exports)
  }
}
